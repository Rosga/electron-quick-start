...
const native = require("./Release/electron-quick-start.node");

// TODO: write function for every native method with typings

const startHook = native.startHook;
const stopHook = native.stopHook;
...
class IOHook extends EventEmitter {
     ...
     */
    load() {
        startHook(this._handler.bind(this), this.debug || false);
    }
